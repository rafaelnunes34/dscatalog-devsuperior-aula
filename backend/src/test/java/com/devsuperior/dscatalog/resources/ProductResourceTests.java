...
public class ProductResourceTests {
	...
	void setUp() throws Exception {
		...
		when(service.update(ArgumentMatchers.eq(nonExistingId), ArgumentMatchers.any())).thenThrow(EntityNotFoundException.class);
	...
	@Test
	public void insertShouldReturnProdutDTOCreated() throws Exception {
	...
	@Test
	public void findByIdReturnNotFoundWhenIdDoesNotExist() throws Exception {
